...
1. In your own words, define closure (1-2 sentences).
  Closure makes inner function have access to outer function.
...
a. Where is closure used in this code? How can you tell?
  closure is used right beside return. because that is a function inside a personalDice function.
